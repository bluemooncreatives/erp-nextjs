...
export default async function CarryForwardPage() {
  ...
  return <><PageHeader title="Leave Carry Forward" actions={canGenerate ? <form action={generateCarryForwardAction}><ActionButton variant="primary" confirm="Regenerate carry-forward balances from leave records?"><Phrase>Generate Carry Forward</Phrase></ActionButton></form> : null} />
