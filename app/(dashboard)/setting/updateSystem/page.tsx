...
export default async function SystemUpdatePage() {
  ...
  return <div className="space-y-6"><PageHeader title="System Updates" />
    <Card title="Installed Version"><p className="text-sm text-foreground">ERP version: {setting.systemVersion}. Last updated: {setting.lastUpdatedDate ?? 'Not recorded'}.</p>
      <p className="mt-3 text-sm text-muted-foreground">Legacy PHP update packages cannot be installed in this Next.js application. Application updates must be deployed by your administrator. Package upload is unavailable until a compatible update format is provided.</p>
    </Card>
