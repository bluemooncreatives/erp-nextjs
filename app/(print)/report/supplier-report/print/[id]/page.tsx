// Supplier history print view - port of SupplierReportController@showHistory's
// `$request->has('print')` branch (`report::supplier_report.print_view`).
//
// See the customer-report print page for why this is its own route rather
// than a query parameter on `supplier_report.history`.
...
export default async function SupplierHistoryPrintPage({
  params,
}: {
  ...
  return (
    <>
      ...
      <h1 className="mt-5 text-lg font-semibold text-gray-900">Supplier History - {contact.name}</h1>
