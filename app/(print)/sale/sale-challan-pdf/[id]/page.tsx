// Sale challan PDF - the `*_pdf` route. dompdf produced a file here; this renders the
...
import PrintView, { metadata as printMetadata } from '../../sale-challan-print-view/[id]/page';
